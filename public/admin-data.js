...
const AdminData = (() => {
  ...
  const defaultUniversities = [
    { id: 1,  name: 'University College London', logo: 'UCL',  country: 'United Kingdom', cc: 'uk', flag: '🇬🇧', city: 'London',     founded: 1826, ranking: 9,  acceptance: 15, tuition: '£36k/yr',  photo: 'assets/img-2.svg' },
    { id: 2,  name: 'Imperial College London',   logo: 'IC',   country: 'United Kingdom', cc: 'uk', flag: '🇬🇧', city: 'London',     founded: 1907, ranking: 8,  acceptance: 14, tuition: '£36k/yr',  photo: 'assets/img-3.svg' },
    { id: 3,  name: 'University of Toronto',      logo: 'UofT', country: 'Canada',         cc: 'ca', flag: '🇨🇦', city: 'Toronto',    founded: 1827, ranking: 21, acceptance: 43, tuition: 'CAD $58k', photo: 'assets/img-4.svg' },
    { id: 4,  name: 'New York University',        logo: 'NYU',  country: 'United States',  cc: 'us', flag: '🇺🇸', city: 'New York',   founded: 1831, ranking: 38, acceptance: 21, tuition: '$60k/yr',  photo: 'assets/img-4.svg' },
    { id: 5,  name: 'Monash University',          logo: 'MON',  country: 'Australia',      cc: 'au', flag: '🇦🇺', city: 'Melbourne',  founded: 1958, ranking: 49, acceptance: 60, tuition: 'AUD $42k', photo: 'assets/img-4.svg' },
    { id: 6,  name: 'ETH Zürich',                 logo: 'ETH',  country: 'Switzerland',    cc: 'ch', flag: '🇨🇭', city: 'Zürich',     founded: 1855, ranking: 7,  acceptance: 27, tuition: 'CHF 1.5k', photo: 'assets/img-1.svg' },
    { id: 7,  name: 'Trinity College Dublin',     logo: 'TCD',  country: 'Ireland',        cc: 'ie', flag: '🇮🇪', city: 'Dublin',     founded: 1592, ranking: 87, acceptance: 34, tuition: '€21k/yr',  photo: 'assets/img-2.svg' },
    { id: 8,  name: 'TU Munich',                  logo: 'TUM',  country: 'Germany',        cc: 'de', flag: '🇩🇪', city: 'Munich',     founded: 1868, ranking: 30, acceptance: 8,  tuition: '€0 tuition',photo: 'assets/img-2.svg' },
    { id: 9,  name: 'University of Edinburgh',     logo: 'EDI',  country: 'United Kingdom', cc: 'uk', flag: '🇬🇧', city: 'Edinburgh',  founded: 1583, ranking: 22, acceptance: 40, tuition: '£29k/yr',  photo: 'assets/img-1.svg' },
  ];
  ...
  const clients = [
    { id: 'aanya',  name: 'Aanya Raj',     email: 'aanya.raj@example.com', avatar: 'assets/avatar.svg', counsellor: 'Riya Sharma',  apps: 5, stage: 'offer',  course: 'UCL · MSc Data Science', online: true,
      stats: { applications: 5, offers: 2, documents: 14 }, threadId: 'client:aanya' },
    { id: 'diego',  name: 'Diego Morales', email: 'diego.m@example.com',   avatar: 'assets/avatar.svg', counsellor: 'Marco Bellini', apps: 3, stage: 'active', course: 'U of Toronto · Civil Eng', online: false,
      stats: { applications: 3, offers: 1, documents: 9 }, threadId: 'client:diego' },
    { id: 'mei',    name: 'Mei Lin',       email: 'mei.lin@example.com',   avatar: 'assets/avatar.svg', counsellor: 'Sara Okonkwo', apps: 2, stage: 'active', course: 'Monash · MBA', online: true,
      stats: { applications: 2, offers: 0, documents: 7 }, threadId: 'client:mei' },
    { id: 'tobi',   name: 'Tobi Adeyemi',  email: 'tobi.a@example.com',    avatar: 'assets/avatar.svg', counsellor: 'Riya Sharma',  apps: 4, stage: 'offer',  course: 'NYU · MFA Film', online: false,
      stats: { applications: 4, offers: 3, documents: 11 }, threadId: 'client:tobi' },
    { id: 'rahul',  name: 'Rahul Patel',   email: 'rahul.p@example.com',   avatar: 'assets/avatar.svg', counsellor: 'Marco Bellini', apps: 2, stage: 'new',    course: 'TU Munich · MS CS', online: false,
      stats: { applications: 2, offers: 0, documents: 4 }, threadId: 'client:rahul' },
    { id: 'sara',   name: 'Sara Khan',     email: 'sara.k@example.com',    avatar: 'assets/avatar.svg', counsellor: 'Sara Okonkwo', apps: 1, stage: 'new',    course: 'Trinity · MSc', online: true,
  ...
  const counsellors = [
    { name: 'Riya Sharma',   avatar: 'assets/avatar.svg', specialty: 'Applications & strategy', clients: 2, online: true },
    { name: 'Marco Bellini', avatar: 'assets/avatar.svg', specialty: 'SOPs & essays',           clients: 2, online: false },
    { name: 'Sara Okonkwo',  avatar: 'assets/avatar.svg', specialty: 'Visas & documentation',   clients: 2, online: true },
  ];
